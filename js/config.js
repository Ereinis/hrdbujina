...
export const ROLES = {
  ...
  VICE_CHAIRMAN:       '1448497242515439706',
...
export const CAN_SUBMIT_CASES       = [ROLES.PRESIDENT, ROLES.VICE_PRESIDENT, ROLES.EXECUTIVE_DIRECTOR, ROLES.EXECUTIVE_OFFICER, ROLES.EXECUTIVE_ASSISTANT];
export const CAN_ADD_INTERVIEWS     = [ROLES.PRESIDENT, ROLES.VICE_PRESIDENT, ROLES.EXECUTIVE_DIRECTOR, ROLES.EXECUTIVE_OFFICER, ROLES.EXECUTIVE_ASSISTANT];
export const CAN_DELETE_INTERVIEWS  = [ROLES.PRESIDENT, ROLES.VICE_PRESIDENT];
